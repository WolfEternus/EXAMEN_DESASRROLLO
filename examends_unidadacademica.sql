...
CREATE TABLE `unidadacademica` (
  `idUnidadA` int(11) NOT NULL,
  `nombreUnidadAca` varchar(45) DEFAULT NULL,
  `horasClase` datetime DEFAULT NULL,
  `horasTaller` datetime DEFAULT NULL,
  `horasLaboratorio` datetime DEFAULT NULL,
  PRIMARY KEY (`idUnidadA`)
